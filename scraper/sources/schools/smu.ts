...
export class SMUScraper extends BaseScraper {
  ...
  async scrape(): Promise<ScrapedEvent[]> {
    ...
    try {
      ...
      await page.goto('https://www.smu.edu.sg/events', { waitUntil: 'domcontentloaded', timeout: 30000 })
      ...
      for (const item of items) {
        ...
        events.push({
          ...
          location_name: item.venue || 'SMU',
          location_address: item.venue ? `${item.venue}, Singapore Management University, Singapore` : 'Singapore Management University, Singapore',
