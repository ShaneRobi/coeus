...
export class RPScraper extends BaseScraper {
  readonly source = 'rp'
  ...
  async scrape(): Promise<ScrapedEvent[]> {
    ...
    try {
      ...
      await page.goto('https://www.rp.edu.sg/life-at-rp/events', { waitUntil: 'domcontentloaded', timeout: 30000 })
      ...
      for (const item of items) {
        ...
        events.push({
          ...
          location_name: item.venue || 'RP',
          location_address: item.venue ? `${item.venue}, Republic Polytechnic, Singapore` : 'Republic Polytechnic, Singapore',
