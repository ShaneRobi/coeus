...
export class SPScraper extends BaseScraper {
  readonly source = 'sp'
  ...
  async scrape(): Promise<ScrapedEvent[]> {
    ...
    try {
      ...
      await page.goto('https://www.sp.edu.sg/sp/student-services/news-events', { waitUntil: 'domcontentloaded', timeout: 30000 })
      ...
      for (const item of items) {
        ...
        events.push({
          ...
          location_name: item.venue || 'SP',
          location_address: item.venue ? `${item.venue}, Singapore Polytechnic, Singapore` : 'Singapore Polytechnic, Singapore',
