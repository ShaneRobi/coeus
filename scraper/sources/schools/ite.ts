...
export class ITEScraper extends BaseScraper {
  readonly source = 'ite'
  ...
  async scrape(): Promise<ScrapedEvent[]> {
    ...
    try {
      ...
      await page.goto('https://www.ite.edu.sg/events', { waitUntil: 'domcontentloaded', timeout: 30000 })
      ...
      for (const item of items) {
        ...
        events.push({
          ...
          location_name: item.venue || 'ITE',
          location_address: item.venue ? `${item.venue}, Institute of Technical Education, Singapore` : 'Institute of Technical Education, Singapore',
